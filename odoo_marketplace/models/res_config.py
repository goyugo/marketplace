...
class ResConfigSettings(models.TransientModel):
    ...
    inquiry_subject = fields.Char(string='Inquiry Form Subject', related='website_id.mp_inquiry_subject', readonly=False)
    inquiry_message = fields.Text(string='Inquiry Form Message', related='website_id.mp_inquiry_message', readonly=False)
    ...
    product_category_id = fields.Many2one('product.public.category', string='Product Category',
        related='website_id.mp_product_category_id', readonly=False)
    invest_category_id = fields.Many2one('product.public.category', string='Product Category ',
        related='website_id.mp_invest_category_id', readonly=False)
